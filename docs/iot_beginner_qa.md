...
本課程選 ESP32-S3，是因為它便宜、可連網、可以控制實體裝置，也足夠完成智慧停車場與教室偵測。
...
本課共同平台已改為 UCI K-4 4WD，不再由學生裁切或鑽孔底板。基本組成為：
...
UCI 4WD 現在列為期中共同平台，但只要求組裝現成底盤、馬達 mapping、左右差速與校正，不要求木工或自製機構。期中任務是倒車入格與側向停靠，不把差速車宣稱為真實汽車式前輪轉向。
