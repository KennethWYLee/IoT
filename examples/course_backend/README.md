...
This is the shared executable example for Weeks 6, 10, 11, 13, and 14:
...
Open PowerShell in `examples/course_backend`, then run each command separately:
