...
| 3 | ESP32-S3、麵包板、公對公／公對母線與KY-018；電阻包中的1 kΩ／10 kΩ各一顆做分壓；攜帶組內萬用電表 |
| 4 | ESP32-S3、麵包板、三種杜邦線、KY-018與DHT11；220 Ω／330 Ω各一顆做辨識與量程比較；母對母線至少一條連DHT11資料腳；攜帶組內萬用電表 |
| 5 | 增加KY-016、KY-012、SG90、4AA電池盒、AA電池、已公布的轉接端子及組內萬用電表 |
| 6 | 重用Week 2～5材料與組內萬用電表，兩顆按鈕分任START與實體STOP，完成單機互動及故障復原；不使用網路或Backend |
...
正式週次與成果定義見[18週課程規劃](../../docs/course/18_week_plan.md)。
