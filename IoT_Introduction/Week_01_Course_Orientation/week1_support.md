...
| 2 | ESP32-S3、USB資料線、麵包板、杜邦線與按鈕；共用萬用電表 |
| 3 | ESP32-S3、麵包板、杜邦線、電阻包與KY-018；共用萬用電表，完成電氣量測與ADC基礎 |
| 4 | ESP32-S3、麵包板、杜邦線、KY-018與DHT11，完成感測校正與資料品質判讀 |
| 5 | 增加KY-016、KY-012、SG90、4AA電池盒、AA電池及已公布的轉接端子 |
| 6 | 重用Week 2～5材料完成單機互動、安全停止與故障復原；不使用網路或Backend |
| 7 | 第一次個人筆試；不攜帶或操作硬體 |
