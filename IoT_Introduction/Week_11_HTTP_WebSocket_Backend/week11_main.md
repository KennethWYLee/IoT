...
3. 已依[Python與Git課前準備](week11_support.md#課前安裝python與git)
   確認Git與Python命令可顯示版本；版本記錄於
   [Week 11支援資料](week11_support.md#一課前環境與器材確認)。
...
[Week 11分層故障表](week11_support.md#四分層故障排查表)修正，不能先改ESP32程式。
...
[Week 11支援資料](week11_support.md#三命令追蹤與資料流紀錄)。
