...
assert(sources[14].startsWith('### 步驟1：'));
assert(sources.some(s=>s.includes('w3-memory-details')&&s.includes('### Verify的21%與6%')));
assert(sources[11].indexOf('### 10.4 電表要碰哪裡')<sources[11].indexOf('### 10.6 例子一'));
