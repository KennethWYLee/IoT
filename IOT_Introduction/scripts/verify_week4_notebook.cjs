...
for(const c of nb.cells){
 ...
 for(const m of s.matchAll(/!\[[^\]]+\]\(([^)]+)\)/g)){
   ...
   const original=key.startsWith('week4-')?path.join(root,'IOT_Introduction/docs/images/wiring',key):path.join(root,'IOT_Introduction/docs/images/hardware/actual',key);
