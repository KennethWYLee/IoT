...
SOURCES = (
    ...
    ROOT / "IOT_Introduction/docs/archive/week5_standalone/week5_main.md",
...
WEEK3_EXAMPLES = (
    ROOT / "IOT_Introduction/examples/week03_gpio_voltage_cycle/week03_gpio_voltage_cycle.ino",
...
def verify_week3_example_sync() -> None:
    ...
    if len(notebook_sketches) != len(WEEK3_EXAMPLES):
        raise ValueError(
            ...
            f"{len(notebook_sketches)} notebook, {len(WEEK3_EXAMPLES)} IOT_Introduction/examples"
        )
