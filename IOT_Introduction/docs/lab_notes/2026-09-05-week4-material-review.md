...
python -m py_compile IOT_Introduction/scripts/verify_week4_host.py IOT_Introduction/scripts/verify_course_materials.py IOT_Introduction/scripts/verify_markdown_arduino.py
node --check IOT_Introduction/scripts/build_week4_materials.cjs
node --check IOT_Introduction/scripts/verify_week4_notebook.cjs
git diff --check
```
...
- 維護正文：`IOT_Introduction/docs/course_materials/week4_main.source.md`。
- 程式：`IOT_Introduction/examples/week04_ky018_quality/week04_ky018_quality.ino`、
  `IOT_Introduction/examples/week04_dht11_quality/week04_dht11_quality.ino`。
- 圖檔：`IOT_Introduction/docs/images/wiring/week4-`開頭的resistor-bands、meter-ranges、resistor-measurement、
...
- 建置／驗證：`IOT_Introduction/scripts/build_week4_materials.cjs`、`IOT_Introduction/scripts/verify_week4_notebook.cjs`、
  `IOT_Introduction/scripts/verify_week4_host.py`、`IOT_Introduction/scripts/tests/week4/ArduinoFake.h`、`DHT.h`、`host_checks.cpp`；
...
- 直接相關設計與導覽：PROJECT、18_week_plan、18_week_materials_arrival_runbook、
  ...
  及Week 5 support的一個封存連結。本紀錄位於IOT_Introduction/docs/lab_notes，不加入週次目錄。
- 舊稿保留：`IOT_Introduction/docs/archive/week4_actuators/week4_main.md`、`week4_support.md`原樣搬移，另加README。
