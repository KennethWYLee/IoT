...
| Firmware | `IOT_Introduction/examples/week03_gpio_voltage_cycle/week03_gpio_voltage_cycle.ino`; teacher-side candidate `PIN_TEST_OUTPUT=5`; each phase 10,000 ms | GPIO5 alternates steady LOW and HIGH without a load |
