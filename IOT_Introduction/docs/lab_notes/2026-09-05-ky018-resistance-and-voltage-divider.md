...
- `python IOT_Introduction/scripts/verify_course_materials.py`: passed after the revisions; checked
...
- `python IOT_Introduction/scripts/verify_course_materials.py`: PASS,77 Markdown/notebook files,
...
- `python IOT_Introduction/scripts/verify_course_materials.py`: PASS for77 Markdown/notebook files,
