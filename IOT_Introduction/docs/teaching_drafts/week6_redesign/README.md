...
2026-09-17 逐頁檢查另發現操作缺口，包括 p21 缺少 OLED 供電引線、設定與端子步驟不完整；見[逐頁檢查報告](../../lab_notes/2026-09-17-week2-7-page-review/report.md)。目前提交的是待修正草稿，不是實物驗證通過版。
...
| 頁 | 用途 |
|---|---|
| 1–4 | 成果預覽、流程、裸板 Serial 運算 |
| 5–10 | 實物、三線功能、供電、電表、課前設定 |
| 11–19 | STOP 接線、程式、受限動作、電流及資訊流 |
| 20–24 | 紙指針、OLED、共同 count、停止與故障 |
| 25–26 | 概念題與緊接的參考解答 |
| 27–29 | Serial +／− 加減計數延伸 |
| 30–31 | 每次兩格改造題與緊接的參考解答 |
| 32–33 | 收尾、銜接、來源與限制 |
| 34–46 | 三份完整程式，自動從來源嵌入 |
