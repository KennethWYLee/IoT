...
同日逐頁檢查發現完整配置、30 秒遊戲跨頁操作及返回低功率版步驟仍需修正，見[逐頁檢查報告](../../lab_notes/2026-09-17-week2-7-page-review/report.md)。本次版本化保存這些問題，不表示學生已能完整跟做。
...
| 頁 | 內容 |
|---|---|
| 1–4 | 作品、規則演示、時間安排、GPIO責任 |
| 5–11 | 供電列、兩鍵、KY、RGB、OLED、設定及上傳 |
| 12–14 | 第一局：Start、持續遮光、Finish、重新待機 |
| 15–21 | 計時、事件、門檻、優先順序、狀態、log、故障 |
| 22–23 | 概念題，下一頁參考解答 |
| 24–26 | 有條件加入舵機與蜂鳴器，布局及光學干擾 |
| 27–28 | 同樣30秒，每色從3秒改5秒；相同事件比較 |
| 29–30 | 改每色1.5秒的練習，下一頁解答 |
| 31–33 | 排錯、證據與報告銜接、來源 |
| 34–45 | 自動嵌入的完整遊戲程式 |
