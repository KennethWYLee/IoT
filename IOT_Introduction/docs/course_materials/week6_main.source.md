...
![SG90實物標籤、三線接頭及舵盤配件；包裝照片不證明電氣規格](../images/hardware/actual/SG90_2.jpg)
...
![4AA電池盒實物外觀；照片未證明開關、內槽與安全端子均已核對](../images/hardware/actual/BatteryHolder4AA_2.jpg)
...
![教師實拍降壓模組：VIN已接電池、VOUT尚空接；IN燈亮，顯示6.47](../images/hardware/actual/BuckConverter_3.jpg)
...
[BOARD-T01交接紀錄](../lab_notes/2026-09-07-week7-bringup.md)。
...
本段只確認「受限命令能否造成平穩小動作，以及如何停止」。脈寬、相容上電順序與
初次小範圍由教師先驗證公布；學生核對自己的供電與零件，不自行拿0～180度試出極限。
通過本段後，才讀第7.3節的七格映射並安裝紙指針；OLED仍不接。
